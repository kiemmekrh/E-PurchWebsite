    ...
    tbody.innerHTML = invoices.map(inv => `
        <tr>
            ...
            <td>
                ...
                <a href="${escapeHtml(inv.file_path)}" target="_blank" class="btn btn-secondary btn-small">📎</a>
            </td>
        </tr>
    `).join('');
}
        ...
        .then(data => {
            ...
            document.getElementById('invoiceDetail').innerHTML = `
                <div class="detail-grid" style="display: grid; grid-template-columns: 1fr 1fr; gap: 15px;">
                    ...
                    <div><strong>File:</strong> <a href="${escapeHtml(inv.file_path)}" target="_blank">📎 View File</a></div>
                </div>
            `;
